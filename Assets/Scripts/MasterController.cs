...
public class MasterController : MonoBehaviour
{
    ...
    public XRController RightDrawInteractor;
    public XRController LeftDrawInteractor;

    private XRController RightGrabController;
    private XRController LeftGrabController;
    ...
    void Awake()
    {
        ...
        RightGrabController = RightDirectInteractor.GetComponent<XRController>();
        LeftGrabController = LeftDirectInteractor.GetComponent<XRController>();
    ...
    public void EnableGrabController(InputDevice hand)
    {
        if (hand == m_LeftInputDevice)
        {
            LeftGrabController.hideControllerModel = false;
            LeftGrabController.enableInputActions = true;
        }
        else if (hand == m_RightInputDevice)
        {
            RightGrabController.hideControllerModel = false;
            RightGrabController.enableInputActions = true;
        }
    }

    public void DisableGrabController(InputDevice hand)
    {
        if (hand == m_LeftInputDevice)
        {
            LeftGrabController.hideControllerModel = true;
            LeftGrabController.enableInputActions = false;
        }
        else if (hand == m_RightInputDevice)
        {
            RightGrabController.hideControllerModel = true;
            RightGrabController.enableInputActions = false;
        }
    }
